                ...
                <div class="right-login">
                    <div class="card-login">
                        <h1>Cadastre-se</h1>
                            ...
                            <div class ="textfield"><label><input type="checkbox" required><a>Termos de Uso (Obrigatório)</a> <a style = "color: white;" target="_blank" href="../views/helpers/termos-de-uso.html">Leia mais</a></label></div>    
